...
public class DataContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Resource>().HasData(
             ...
             new Resource { Id = 11, QuestionId = 20, Path = "/videos/Luma AI dropped a Sora competitor – Dream Machine - text-to-video generator that's open to ALL! #ai.mp4", FileType = FileType.Video, Name = "A_1.mp4" },
             new Resource { Id = 12, QuestionId = 21, Path = "/videos/This is not Morgan Freeman  -  A Deepfake Singularity.mp4", FileType = FileType.Video, Name = "A_1.mp4" },
             new Resource { Id = 13, QuestionId = 22, Path = "/videos/Trump Gets a Kim Jong Un Haircut – Putin Can’t Stop Laughing! 🤣💈.mp4", FileType = FileType.Video, Name = "A_1.mp4" },
             new Resource { Id = 14, QuestionId = 23, Path = "/videos/Viral AI Video Trump & Harris Romance Ahead of U.S. Election.mp4", FileType = FileType.Video, Name = "A_1.mp4" }
        );
        ...
        modelBuilder.Entity<Answer>().HasData(
            ...
            new Answer { Id = 16, QuestionId = 10, Content = "Bien vu, nous avons utilisé Sora, l'outil de création de vidéos mis au point par Open AI pour générer cette fausse vidéo. C'est discret, mais si on regarde bien, le mouvement de la patte n'est pas naturel et, quand on zoome, le grain de l'image est typique de ce que Sora est capable de produire. ", IsCorrect = true },
            new Answer { Id = 17, QuestionId = 10, Content = "Désolé, vous vous êtes trompé, nous avons utilisé Sora, l'outil de création de vidéos mis au point par Open AI pour générer cette fausse vidéo. C'est discret, mais si on regarde bien, le mouvement de la patte n'est pas naturel et, quand on zoome, le grain de l'image est typique de ce que Sora est capable de produire. ", IsCorrect = false },
            new Answer { Id = 18, QuestionId = 11, Content = "Bien vu, il s'agit bien d'une vraie vidéo proposée par Getty Images,", IsCorrect = true },
            new Answer { Id = 19, QuestionId = 11, Content = "Désolé, vous vous êtes trompé, il s'agit en fait un clip vidéo proposé par Getty Images,", IsCorrect = false },
            new Answer { Id = 20, QuestionId = 12, Content = "Bien vu, nous avons utilisé Sora, l'outil de création de vidéos mis au point par Open AI pour générer cette fausse vidéo. Un détail permettait de déceler le fake : le bras d'une personne assise à droite de l'image a esquissé un mouvement pas très naturel. Certaines pailles dans les verres sur le plateau bougent bizarrement aussi. ", IsCorrect = true },
            new Answer { Id = 21, QuestionId = 12, Content = "Désolé, vous vous êtes trompé, nous avons utilisé Sora, l'outil de création de vidéos mis au point par Open AI pour générer cette fausse vidéo. Certains détails auraient pu vous mettre sur la piste  : le bras d'une personne assise à droite de l'image a esquissé un mouvement pas très naturel. Certaines pailles dans les verres sur le plateau bougent bizarrement aussi. ", IsCorrect = false },
            new Answer { Id = 22, QuestionId = 13, Content = "Bien vu, il s'agit bien d'une vraie vidéo proposée par Getty Images,", IsCorrect = true },
            new Answer { Id = 23, QuestionId = 13, Content = "Désolé, vous vous êtes trompé, il s'agit en fait un clip vidéo proposé par Getty Images,", IsCorrect = false },
            new Answer { Id = 24, QuestionId = 14, Content = "Bravo, décidément, on ne vous la fait pas à vous!. Il faut dire que c'était facile avec le téléphone gigantesque en arrière-plan et les mains qui semblent à peine toucher le clavier. Nous avons utilisé Sora, l'outil de création de vidéos mis au point par Open AI pour générer cette vidéo,", IsCorrect = true },
            new Answer { Id = 25, QuestionId = 14, Content = "Désolé, vous vous êtes trompé, vous auriez pu trouver, si vous aviez remarqué le téléphone gigantesque en arrière-plan et les mains qui semblent à peine toucher le clavier, vous auriez pu trouver. Nous avons utilisé Sora, l'outil de création de vidéos mis au point par Open AI pour générer la première vidéo.", IsCorrect = false },
            new Answer { Id = 26, QuestionId = 15, Content = "Bien vu, il s'agit bien d'une vraie vidéo proposée par Getty Images,", IsCorrect = true },
            new Answer { Id = 27, QuestionId = 15, Content = "Désolé, vous vous êtes trompé, il s'agit en fait un clip vidéo proposé par Getty Images,", IsCorrect = false },
            new Answer { Id = 28, QuestionId = 16, Content = "Bien vu ! Vous avez peut-être été frappé par l'aspect trop lisse des bâtiments et par le drapeau américain au premier plan qui bouge avec un mouvement pas très naturel. Encore une fois, c'est l'oeuvre de Sora, tandis que l'autre vidéo vient de Getty Images.", IsCorrect = true },
            new Answer { Id = 29, QuestionId = 16, Content = "Désolé, vous vous êtes trompé, vous auriez pu deviner, si vous aviez remarqué  l'aspect trop lisse des bâtiments et par le drapeau américain au premier plan qui bouge avec un mouvement pas très naturel. Encore une fois, c'est l'oeuvre de Sora,", IsCorrect = false },
            new Answer { Id = 30, QuestionId = 17, Content = "Bien vu, il s'agit bien d'une vraie vidéo proposée par Getty Images,", IsCorrect = true },
            new Answer { Id = 31, QuestionId = 17, Content = "Désolé, vous vous êtes trompé, il s'agit en fait un clip vidéo proposé par Getty Images,", IsCorrect = false },
            new Answer { Id = 32, QuestionId = 18, Content = "Bien vu !  Ce jeune homme est le résultat de l'imagination de l'IA", IsCorrect = true },
            new Answer { Id = 33, QuestionId = 18, Content = "Désolé, vous vous êtes trompé ! Ce jeune homme est le résultat de l'imagination de l'IA", IsCorrect = false },
            new Answer { Id = 34, QuestionId = 19, Content = "Bien vu, il s'agit bien d'une vidéo probablement tournée sur un trampoline, qui vient de Getty Images.", IsCorrect = true },
            new Answer { Id = 35, QuestionId = 19, Content = "Désolé, il s'agit en faite d'une vidéo de Getty Images probablement tournée sur un trampoline.", IsCorrect = false },
            new Answer { Id = 36, QuestionId = 20, Content = "Vrai", IsCorrect = true },
            new Answer { Id = 37, QuestionId = 20, Content = "Faux", IsCorrect = false },
            new Answer { Id = 38, QuestionId = 21, Content = "Vrai", IsCorrect = true },
            new Answer { Id = 39, QuestionId = 21, Content = "Faux", IsCorrect = false },
            new Answer { Id = 40, QuestionId = 22, Content = "Vrai", IsCorrect = true },
            new Answer { Id = 41, QuestionId = 22, Content = "Faux", IsCorrect = false },
            new Answer { Id = 42, QuestionId = 23, Content = "Vrai", IsCorrect = true },
            new Answer { Id = 43, QuestionId = 23, Content = "Faux", IsCorrect = false }
            );
